      ...
      <main className="dashboard-main">
        ...
        <section className="dashboard-videos">
          <div className="dashboard-video-placeholder">
            <div className="dashboard-video-inner">
              <span className="dashboard-video-icon">▶</span>
              <span className="dashboard-video-label">Drone Live View</span>
            </div>
          </div>
          <div className="dashboard-video-placeholder">
            <div className="dashboard-video-inner">
              <span className="dashboard-video-icon">◉</span>
              <span className="dashboard-video-label">SLAM Terrain Reconstruction</span>
            </div>
          </div>
        </section>
